  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <LineChart data={data} margin={{ left: -12, right: 12, top: 8 }}>
        ...
        <XAxis dataKey="month" tickLine={false} axisLine={false} tick={{ fill: chartTheme.muted, fontSize: 12 }} />
        ...
        />
        <Legend />
        <Line type="monotone" dataKey="mrr" name="mrr" stroke={chartTheme.accent} strokeWidth={2} dot={false} />
        <Line type="monotone" dataKey="newRevenue" name="newRevenue" stroke={chartTheme.accentSoft} strokeWidth={2} dot={false} strokeDasharray="5 3" />
        <Line type="monotone" dataKey="churn" name="churn" stroke="#64748B" strokeWidth={2} dot={false} strokeDasharray="5 3" />
      </LineChart>
    </ResponsiveContainer>
  );
}
